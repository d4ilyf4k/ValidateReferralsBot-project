...
async def send_bank_info_and_link(message: types.Message, state: FSMContext):
    ...
    # Сохраняем выбор банка в состоянии
    ...
    if bank_key == "t-bank":
        ...
        # Теперь отправляем условия получения бонуса 500₽
        desc = (
            "<b>🏦 Т-Банк | Карта Tinkoff Black</b>\n\n"
            
            "<b>📋 Условия для получения бонуса 500₽:</b>\n\n"
            ...
            "<b>💰 Что вы получаете (кроме участия в новогодней акции):</b>\n\n"
